          ...
          <div className="flex flex-col md:flex-row justify-between items-center">
            <div className="flex flex-wrap justify-center md:justify-start gap-6 text-sm text-gray-400 mb-6 md:mb-0">
              <a className="group relative cursor-pointer hover:text-white transition-colors duration-300">
                ...
                <div className="absolute bottom-full left-1/2 -translate-x-1/2 mb-3 w-64 px-4 py-3 bg-gray-800 border border-gray-700 rounded-lg shadow-xl text-xs text-gray-300 leading-relaxed opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-300 z-20 pointer-events-none">
              ...
              <a className="group relative cursor-pointer hover:text-white transition-colors duration-300">
                ...
                <div className="absolute inset-0 bg-gradient-to-r from-primary-600/20 to-purple-600/20 rounded-lg opacity-0 group-hover:opacity-100 transition-opacity duration-300 -inset-2"></div>
                <div className="absolute bottom-full left-1/2 -translate-x-1/2 mb-3 w-64 px-4 py-3 bg-gray-800 border border-gray-700 rounded-lg shadow-xl text-xs text-gray-300 leading-relaxed opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-300 z-20 pointer-events-none">
                  By using JobPortal, you agree to our terms and conditions
                  governing your use of the platform, including your rights and
                  responsibilities.
                  <div className="absolute top-full left-1/2 -translate-x-1/2 w-3 h-3 bg-gray-800 border-r border-b border-gray-700 rotate-45 -mt-1.5"></div>
                </div>
              </a>
              <a className="group relative cursor-pointer hover:text-white transition-colors duration-300">
                ...
                <div className="absolute bottom-full left-1/2 -translate-x-1/2 mb-3 w-64 px-4 py-3 bg-gray-800 border border-gray-700 rounded-lg shadow-xl text-xs text-gray-300 leading-relaxed opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-300 z-20 pointer-events-none">
                  ...
                  traffic, and personalize content. By continuing to use JobPortal,
